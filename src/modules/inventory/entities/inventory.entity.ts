...
export class StockMovement extends BaseEntity {
  ...
  /**
   * Per-line idempotency key for the batch endpoint. UUID generated by
   * the scanner client at scan time; persists across retries and offline
   * queue replays. Partial unique index in the migration enforces
   * uniqueness when set; NULL is allowed for non-batch movements.
   */
